CLASS zcl_generate_travel_data_726 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_726 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_726.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_726.

*   insert the new table entries
    INSERT ztravel_726 FROM TABLE @itab.
