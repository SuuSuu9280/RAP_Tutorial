CLASS zcl_generate_travel_data_928 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_928 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_928.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_928.

*   insert the new table entries
    INSERT ztravel_928 FROM TABLE @itab.
